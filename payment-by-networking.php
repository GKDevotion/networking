...
<head>
    ...
    <title>Networking - Payemnt By Networking</title>
        ...
        <div class="vlo-populer-posts-4">
            <div class="container">
                ...
                <section class="hero-section">
                    <div class="container">  
                        <p class="lead">
                           Boundless banking payment solutions, endless growth opportunities
                        </p>

                        <div class="d-flex flex-wrap justify-content-center gap-3">
                            <button class="btn btn-gold">Discover All Payment Solution</button> 
                            <button class="btn btn-telegram">
                                Payment Solution Telegram &nbsp;<i class="bi bi-telegram"></i>
                            </button>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="row g-3 filter-row justify-content-center">
                            ...
                            <div class="col-12 col-md-4">
                                <select class="form-select">
                                    ...
                                    <option>Financial Trading</option>
                                    <option>Fintech</option>
                                    <option>Gamblig & Betting</option>
                                    <option>i Gaming</option>
                                    <option>Travel</option>
                                    <option>Various Activities</option> 
                                </select>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <select class="form-select">
                                    ...
                                    <option>Asia</option>
                                    <option>Australia & Newzealand</option>
