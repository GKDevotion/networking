...
<head>
    ...
    <link rel="stylesheet" href="assets/css/elements/blog.css">
...
<body class="vlo-marketing-blog vlo-marketing">
        ...
        <div class="vlo-populer-posts-4">
            <div class="container">
                ...
                <section class="hero-section">
                    <div class="container">
                        <h1>Welcome to the ClearSky Network Marketplace</h1>
                        <p class="lead">
                            Utilize Our Extensive Network And Boundless Connections, To Enhance Your Business Portfolio
                            And Venture Out Into New Verticals. Our Marketplace Has
                            <span class="highlight">Everything You Need</span>
                            To Generate A Successful Business Platform And Provide You With High-Quality Services.
                            <span class="highlight">Discover</span> The Community And All We Have To Offer.
                        </p>

                        <div class="d-flex flex-wrap justify-content-center gap-3">
                            <button class="btn btn-gold">View Offers</button>
                            <button class="btn btn-gold">Publish Offer</button>
                            <button class="btn btn-telegram">
                                MarketplaceTelegram &nbsp;<i class="bi bi-telegram"></i>
                            </button>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="row g-3 filter-row justify-content-center">
                            ...
                            <div class="col-12 col-md-4">
                                <select class="form-select">
                                    <option value="" disabled selected>Select Jurisdictions</option>
