            ...
            <div class="row">
               <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="footer-logo">
                     <a href="index-2.html"><img src="assets/images/logo/vlo-footer-logo-1.svg" alt="logo"></a>
               ...
               <div class="col-lg-3 col-6 col-sm-6 col-6">
                  <div class="footer-categories-widget">
                     <h5 class="footer-menu-name">Categories</h5>
                     <ul class="menu-list">
                        <li><a href="travel-about.html"> Style</a></li>
                        <li><a href="travel-about.html"> Travel</a></li>
                        <li><a href="travel-about.html"> Lifestyle</a></li>
                        <li><a href="travel-about.html"> Fashion</a></li>
                     </ul>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                  <div class="footer-pages-widget">
                     ...
                     <ul class="menu-list">
                        <li><a href="photograpy-about.html">About Me</a></li>
                        <li><a href="photograpy-blog.html">News</a></li>
               ...
               <div class="col-lg-2 col-md-6 col-sm-6 col-6">
                  <div class="footer-support-widget">
                     ...
                     <ul class="menu-list">
                        <li><a href="travel-about.html">Support Center</a></li>
                        <li><a href="travel-about.html">Feedback</a></li>
                        <li><a href="travel-about.html">Terms & Condition</a></li>
                     </ul>
                  </div>
               </div>
            </div>
